...
INSERT INTO meal (title, description, location, `when`, max_reservations, price, created_date)VALUES("Ramen","fresh noodles in steaming broth, topped with meats or vegetables","Vesterbro","2021-06-11 15:41:00",14,"150","2020-06-14 13:00:00");
INSERT INTO meal(title, description, location, `when`, max_reservations, price, created_date)VALUES ("Firecracker chicken","a fiery mix of chicken,red and green peppers","Frederiksberg", "2021-12-23 11:36:00", 10,"120","2020-12-25 19:30:00");
INSERT INTO meal (title, description, location, `when`, max_reservations, price, created_date)VALUES("Durum shawarma","Shawarma in durum wrap with vegetables","Nørrebro", "2021-11-12 18:21:00",15,"40","2020-11-12 12:00:00");
INSERT INTO meal (title, description, location, `when`, max_reservations, price, created_date)VALUES("Chicken raisukaree","a mild, coconut and citrus curry, with chicken", "Amager","2021-05-05 15:11:00", 12,"110","2020-05-09 19:00:00");
INSERT INTO meal (title, description, location, `when`, max_reservations, price, created_date)VALUES("Katsu curry","vegetables in crispy panko breadcrumbs and covered in curry sauce", "Sydhavn","2021-11-21 11:33:00",12,"160","2020-11-25 12:10:00");
...
INSERT INTO review(title, description, meal_id, stars, created_date)VALUES("Terrible", "The food sucked AF", 3, 1, "2021-11-12");
INSERT INTO review(title, description, meal_id, stars, created_date)VALUES("Excellent","It was really tasty",1, 5, "2021-12-22");
INSERT INTO review(title, description, meal_id, stars, created_date)VALUES("Good","Mmmmm, nom nom", 2, 2, "2021-06-30");
INSERT INTO review(title, description, meal_id, stars, created_date)VALUES("Terrible","Made me wanna throw up", 4, 1, "2021-08-13");
INSERT INTO review(title, description, meal_id, stars, created_date)VALUES("Excellent","Great meal, perfect service", 5, 4, "2021-09-22");
...
SELECT * FROM meal WHERE created_date BETWEEN "2020-01-01" AND "2020-06-15";
/* Get only specific number of meals fx return only 5 meals */
SELECT * FROM meal ORDER BY id LIMIT 5;
/* Get the meals that have good reviews */
SELECT * FROM meal JOIN review ON review.meal_id = meal.id WHERE stars > 3 ORDER BY stars DESC;
/* Get reservations for a specific meal sorted by created_date */
SELECT meal.id, meal.title, reservation.meal_id, reservation.created_date FROM meal, reservation WHERE meal.title LIKE "Katsu curry" 
AND meal.id = reservation.meal_id ORDER BY reservation.created_date;
/* Sort all meals by average number of stars in the reviews */
SELECT meal.* FROM meal JOIN review ON meal.id= review.meal_id GROUP BY review.meal_id ORDER BY AVG(review.stars);
